...
struct pubsub_opts opts =
{
	0, 0, 1, 0, "\n", 100,  	/* debug/app options */
	NULL, NULL, 1, 0, 0, /* message options */
	MQTTVERSION_DEFAULT, NULL, "paho-c-sub", 0, 0,"YS04G" , "wf070irify6b", "123.58.243.147", "8883", "ssl://123.58.243.147:8883", 10, /* MQTT options */
	NULL, NULL, 0, 0, /* will options */
	0, NULL, "./client-cert.pem", "./cacert.pem", "./client-key.pem", NULL, NULL, /* TLS options */
	0, {NULL, NULL}, /* MQTT V5 options */
};
